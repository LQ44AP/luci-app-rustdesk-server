local m = Map("rustdesk-server", translate("RustDesk 服务器设置"))

-- 全局设置
local s_global = m:section(NamedSection, "global", "global", translate("基础配置"))
local data_dir = s_global:option(Value, "data_dir", translate("数据目录"))
